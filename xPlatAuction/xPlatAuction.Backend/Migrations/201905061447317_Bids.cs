    ...
    public partial class Bids : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AuctionItemDbEntities", t => t.AuctionItem_Id)
        ...
        {
            DropForeignKey("dbo.Bids", "AuctionItem_Id", "dbo.AuctionItemDbEntities");
            DropForeignKey("dbo.AuctionItemDbEntities", "Auction_Id", "dbo.Auctions");
            DropIndex("dbo.Bids", new[] { "CreatedAt" });
            DropIndex("dbo.Bids", new[] { "AuctionItem_Id" });
            DropIndex("dbo.AuctionItemDbEntities", new[] { "CreatedAt" });
            DropIndex("dbo.AuctionItemDbEntities", new[] { "Auction_Id" });
            DropTable("dbo.Bids",
            ...
            DropTable("dbo.AuctionItemDbEntities",
                removedColumnAnnotations: new Dictionary<string, IDictionary<string, object>>
                {
                    {
                        "CreatedAt",
